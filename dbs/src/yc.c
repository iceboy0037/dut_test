...
PT_MAP_START(yc)
	...
	PT_ITEM("uc1",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[0].uc.raw)
	PT_ITEM("uab1",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[0].uab.raw)
	PT_ITEM("ubc1",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[0].ubc.raw)
	PT_ITEM("uca1",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[0].uca.raw)
	PT_ITEM("uz1",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[0].u0.raw)
	PT_ITEM("f1",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[0].f.raw)
	PT_ITEM("ua2",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[1].ua.raw)
	PT_ITEM("ub2",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[1].ub.raw)
	PT_ITEM("uc2",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[1].uc.raw)
	PT_ITEM("uab2",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[1].uab.raw)
	PT_ITEM("ubc2",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[1].ubc.raw)
	PT_ITEM("uca2",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[1].uca.raw)
	PT_ITEM("uz2",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[1].u0.raw)
	PT_ITEM("f2",		PT_TYPE_FLOAT,	struct yc_table_t,	bus[1].f.raw)
	PT_ITEM("ia1",		PT_TYPE_FLOAT,	struct yc_table_t,	line[0].ia.raw)
	PT_ITEM("ib1",		PT_TYPE_FLOAT,	struct yc_table_t,	line[0].ib.raw)
	PT_ITEM("ic1",		PT_TYPE_FLOAT,	struct yc_table_t,	line[0].ic.raw)
	PT_ITEM("iz1",		PT_TYPE_FLOAT,	struct yc_table_t,	line[0].i0.raw)
	PT_ITEM("p1",		PT_TYPE_FLOAT,	struct yc_table_t,	line[0].p.raw)
	PT_ITEM("q1",		PT_TYPE_FLOAT,	struct yc_table_t,	line[0].q.raw)
	PT_ITEM("s1",		PT_TYPE_FLOAT,	struct yc_table_t,	line[0].s.raw)
	PT_ITEM("cos1",		PT_TYPE_FLOAT,	struct yc_table_t,	line[0].cos.raw)
	PT_ITEM("ia2",		PT_TYPE_FLOAT,	struct yc_table_t,	line[1].ia.raw)
	PT_ITEM("ib2",		PT_TYPE_FLOAT,	struct yc_table_t,	line[1].ib.raw)
	PT_ITEM("ic2",		PT_TYPE_FLOAT,	struct yc_table_t,	line[1].ic.raw)
	PT_ITEM("iz2",		PT_TYPE_FLOAT,	struct yc_table_t,	line[1].i0.raw)
	PT_ITEM("p2",		PT_TYPE_FLOAT,	struct yc_table_t,	line[1].p.raw)
	PT_ITEM("q2",		PT_TYPE_FLOAT,	struct yc_table_t,	line[1].q.raw)
	PT_ITEM("s2",		PT_TYPE_FLOAT,	struct yc_table_t,	line[1].s.raw)
	PT_ITEM("cos2",		PT_TYPE_FLOAT,	struct yc_table_t,	line[1].cos.raw)
	PT_ITEM("ia3",		PT_TYPE_FLOAT,	struct yc_table_t,	line[2].ia.raw)
	PT_ITEM("ib3",		PT_TYPE_FLOAT,	struct yc_table_t,	line[2].ib.raw)
	PT_ITEM("ic3",		PT_TYPE_FLOAT,	struct yc_table_t,	line[2].ic.raw)
	PT_ITEM("iz3",		PT_TYPE_FLOAT,	struct yc_table_t,	line[2].i0.raw)
	PT_ITEM("p3",		PT_TYPE_FLOAT,	struct yc_table_t,	line[2].p.raw)
	PT_ITEM("q3",		PT_TYPE_FLOAT,	struct yc_table_t,	line[2].q.raw)
	PT_ITEM("s3",		PT_TYPE_FLOAT,	struct yc_table_t,	line[2].s.raw)
	PT_ITEM("cos3",		PT_TYPE_FLOAT,	struct yc_table_t,	line[2].cos.raw)
	PT_ITEM("ia4",		PT_TYPE_FLOAT,	struct yc_table_t,	line[3].ia.raw)
	PT_ITEM("ib4",		PT_TYPE_FLOAT,	struct yc_table_t,	line[3].ib.raw)
	PT_ITEM("ic4",		PT_TYPE_FLOAT,	struct yc_table_t,	line[3].ic.raw)
	PT_ITEM("iz4",		PT_TYPE_FLOAT,	struct yc_table_t,	line[3].i0.raw)
	PT_ITEM("p4",		PT_TYPE_FLOAT,	struct yc_table_t,	line[3].p.raw)
	PT_ITEM("q4",		PT_TYPE_FLOAT,	struct yc_table_t,	line[3].q.raw)
	PT_ITEM("s4",		PT_TYPE_FLOAT,	struct yc_table_t,	line[3].s.raw)
	PT_ITEM("cos4",		PT_TYPE_FLOAT,	struct yc_table_t,	line[3].cos.raw)
	PT_ITEM("ia5",		PT_TYPE_FLOAT,	struct yc_table_t,	line[4].ia.raw)
	PT_ITEM("ib5",		PT_TYPE_FLOAT,	struct yc_table_t,	line[4].ib.raw)
	PT_ITEM("ic5",		PT_TYPE_FLOAT,	struct yc_table_t,	line[4].ic.raw)
	PT_ITEM("iz5",		PT_TYPE_FLOAT,	struct yc_table_t,	line[4].i0.raw)
	PT_ITEM("p5",		PT_TYPE_FLOAT,	struct yc_table_t,	line[4].p.raw)
	PT_ITEM("q5",		PT_TYPE_FLOAT,	struct yc_table_t,	line[4].q.raw)
	PT_ITEM("s5",		PT_TYPE_FLOAT,	struct yc_table_t,	line[4].s.raw)
	PT_ITEM("cos5",		PT_TYPE_FLOAT,	struct yc_table_t,	line[4].cos.raw)
	PT_ITEM("ia6",		PT_TYPE_FLOAT,	struct yc_table_t,	line[5].ia.raw)
	PT_ITEM("ib6",		PT_TYPE_FLOAT,	struct yc_table_t,	line[5].ib.raw)
	PT_ITEM("ic6",		PT_TYPE_FLOAT,	struct yc_table_t,	line[5].ic.raw)
	PT_ITEM("iz6",		PT_TYPE_FLOAT,	struct yc_table_t,	line[5].i0.raw)
	PT_ITEM("p6",		PT_TYPE_FLOAT,	struct yc_table_t,	line[5].p.raw)
	PT_ITEM("q6",		PT_TYPE_FLOAT,	struct yc_table_t,	line[5].q.raw)
	PT_ITEM("s6",		PT_TYPE_FLOAT,	struct yc_table_t,	line[5].s.raw)
	PT_ITEM("cos6",		PT_TYPE_FLOAT,	struct yc_table_t,	line[5].cos.raw)
	PT_ITEM("ia7",		PT_TYPE_FLOAT,	struct yc_table_t,	line[6].ia.raw)
	PT_ITEM("ib7",		PT_TYPE_FLOAT,	struct yc_table_t,	line[6].ib.raw)
	PT_ITEM("ic7",		PT_TYPE_FLOAT,	struct yc_table_t,	line[6].ic.raw)
	PT_ITEM("iz7",		PT_TYPE_FLOAT,	struct yc_table_t,	line[6].i0.raw)
	PT_ITEM("p7",		PT_TYPE_FLOAT,	struct yc_table_t,	line[6].p.raw)
	PT_ITEM("q7",		PT_TYPE_FLOAT,	struct yc_table_t,	line[6].q.raw)
	PT_ITEM("s7",		PT_TYPE_FLOAT,	struct yc_table_t,	line[6].s.raw)
	PT_ITEM("cos7",		PT_TYPE_FLOAT,	struct yc_table_t,	line[6].cos.raw)
	PT_ITEM("ia8",		PT_TYPE_FLOAT,	struct yc_table_t,	line[7].ia.raw)
	PT_ITEM("ib8",		PT_TYPE_FLOAT,	struct yc_table_t,	line[7].ib.raw)
	PT_ITEM("ic8",		PT_TYPE_FLOAT,	struct yc_table_t,	line[7].ic.raw)
	PT_ITEM("iz8",		PT_TYPE_FLOAT,	struct yc_table_t,	line[7].i0.raw)
	PT_ITEM("p8",		PT_TYPE_FLOAT,	struct yc_table_t,	line[7].p.raw)
	PT_ITEM("q8",		PT_TYPE_FLOAT,	struct yc_table_t,	line[7].q.raw)
	PT_ITEM("s8",		PT_TYPE_FLOAT,	struct yc_table_t,	line[7].s.raw)
	PT_ITEM("cos8",		PT_TYPE_FLOAT,	struct yc_table_t,	line[7].cos.raw)
	PT_ITEM("ia9",		PT_TYPE_FLOAT,	struct yc_table_t,	line[8].ia.raw)
	PT_ITEM("ib9",		PT_TYPE_FLOAT,	struct yc_table_t,	line[8].ib.raw)
	PT_ITEM("ic9",		PT_TYPE_FLOAT,	struct yc_table_t,	line[8].ic.raw)
	PT_ITEM("iz9",		PT_TYPE_FLOAT,	struct yc_table_t,	line[8].i0.raw)
	PT_ITEM("p9",		PT_TYPE_FLOAT,	struct yc_table_t,	line[8].p.raw)
	PT_ITEM("q9",		PT_TYPE_FLOAT,	struct yc_table_t,	line[8].q.raw)
	PT_ITEM("s9",		PT_TYPE_FLOAT,	struct yc_table_t,	line[8].s.raw)
	PT_ITEM("cos9",		PT_TYPE_FLOAT,	struct yc_table_t,	line[8].cos.raw)
	PT_ITEM("ia10",		PT_TYPE_FLOAT,	struct yc_table_t,	line[9].ia.raw)
	PT_ITEM("ib10",		PT_TYPE_FLOAT,	struct yc_table_t,	line[9].ib.raw)
	PT_ITEM("ic10",		PT_TYPE_FLOAT,	struct yc_table_t,	line[9].ic.raw)
	PT_ITEM("iz10",		PT_TYPE_FLOAT,	struct yc_table_t,	line[9].i0.raw)
	PT_ITEM("p10",		PT_TYPE_FLOAT,	struct yc_table_t,	line[9].p.raw)
	PT_ITEM("q10",		PT_TYPE_FLOAT,	struct yc_table_t,	line[9].q.raw)
	PT_ITEM("s10",		PT_TYPE_FLOAT,	struct yc_table_t,	line[9].s.raw)
	PT_ITEM("cos10",	PT_TYPE_FLOAT,	struct yc_table_t,	line[9].cos.raw)
	PT_ITEM("ia11",		PT_TYPE_FLOAT,	struct yc_table_t,	line[10].ia.raw)
	PT_ITEM("ib11",		PT_TYPE_FLOAT,	struct yc_table_t,	line[10].ib.raw)
	PT_ITEM("ic11",		PT_TYPE_FLOAT,	struct yc_table_t,	line[10].ic.raw)
	PT_ITEM("iz11",		PT_TYPE_FLOAT,	struct yc_table_t,	line[10].i0.raw)
	PT_ITEM("p11",		PT_TYPE_FLOAT,	struct yc_table_t,	line[10].p.raw)
	PT_ITEM("q11",		PT_TYPE_FLOAT,	struct yc_table_t,	line[10].q.raw)
	PT_ITEM("s11",		PT_TYPE_FLOAT,	struct yc_table_t,	line[10].s.raw)
	PT_ITEM("cos11",	PT_TYPE_FLOAT,	struct yc_table_t,	line[10].cos.raw)
	PT_ITEM("ia12",		PT_TYPE_FLOAT,	struct yc_table_t,	line[11].ia.raw)
	PT_ITEM("ib12",		PT_TYPE_FLOAT,	struct yc_table_t,	line[11].ib.raw)
	PT_ITEM("ic12",		PT_TYPE_FLOAT,	struct yc_table_t,	line[11].ic.raw)
	PT_ITEM("iz12",		PT_TYPE_FLOAT,	struct yc_table_t,	line[11].i0.raw)
	PT_ITEM("p12",		PT_TYPE_FLOAT,	struct yc_table_t,	line[11].p.raw)
	PT_ITEM("q12",		PT_TYPE_FLOAT,	struct yc_table_t,	line[11].q.raw)
	PT_ITEM("s12",		PT_TYPE_FLOAT,	struct yc_table_t,	line[11].s.raw)
	PT_ITEM("cos12",	PT_TYPE_FLOAT,	struct yc_table_t,	line[11].cos.raw)
	PT_ITEM("ia13",		PT_TYPE_FLOAT,	struct yc_table_t,	line[12].ia.raw)
	PT_ITEM("ib13",		PT_TYPE_FLOAT,	struct yc_table_t,	line[12].ib.raw)
	PT_ITEM("ic13",		PT_TYPE_FLOAT,	struct yc_table_t,	line[12].ic.raw)
	PT_ITEM("iz13",		PT_TYPE_FLOAT,	struct yc_table_t,	line[12].i0.raw)
	PT_ITEM("p13",		PT_TYPE_FLOAT,	struct yc_table_t,	line[12].p.raw)
	PT_ITEM("q13",		PT_TYPE_FLOAT,	struct yc_table_t,	line[12].q.raw)
	PT_ITEM("s13",		PT_TYPE_FLOAT,	struct yc_table_t,	line[12].s.raw)
	PT_ITEM("cos13",	PT_TYPE_FLOAT,	struct yc_table_t,	line[12].cos.raw)
	PT_ITEM("ia14",		PT_TYPE_FLOAT,	struct yc_table_t,	line[13].ia.raw)
	PT_ITEM("ib14",		PT_TYPE_FLOAT,	struct yc_table_t,	line[13].ib.raw)
	PT_ITEM("ic14",		PT_TYPE_FLOAT,	struct yc_table_t,	line[13].ic.raw)
	PT_ITEM("iz14",		PT_TYPE_FLOAT,	struct yc_table_t,	line[13].i0.raw)
	PT_ITEM("p14",		PT_TYPE_FLOAT,	struct yc_table_t,	line[13].p.raw)
	PT_ITEM("q14",		PT_TYPE_FLOAT,	struct yc_table_t,	line[13].q.raw)
	PT_ITEM("s14",		PT_TYPE_FLOAT,	struct yc_table_t,	line[13].s.raw)
	PT_ITEM("cos14",	PT_TYPE_FLOAT,	struct yc_table_t,	line[13].cos.raw)
	PT_ITEM("ia15",		PT_TYPE_FLOAT,	struct yc_table_t,	line[14].ia.raw)
	PT_ITEM("ib15",		PT_TYPE_FLOAT,	struct yc_table_t,	line[14].ib.raw)
	PT_ITEM("ic15",		PT_TYPE_FLOAT,	struct yc_table_t,	line[14].ic.raw)
	PT_ITEM("iz15",		PT_TYPE_FLOAT,	struct yc_table_t,	line[14].i0.raw)
	PT_ITEM("p15",		PT_TYPE_FLOAT,	struct yc_table_t,	line[14].p.raw)
	PT_ITEM("q15",		PT_TYPE_FLOAT,	struct yc_table_t,	line[14].q.raw)
	PT_ITEM("s15",		PT_TYPE_FLOAT,	struct yc_table_t,	line[14].s.raw)
	PT_ITEM("cos15",	PT_TYPE_FLOAT,	struct yc_table_t,	line[14].cos.raw)
	PT_ITEM("ia16",		PT_TYPE_FLOAT,	struct yc_table_t,	line[15].ia.raw)
	PT_ITEM("ib16",		PT_TYPE_FLOAT,	struct yc_table_t,	line[15].ib.raw)
	PT_ITEM("ic16",		PT_TYPE_FLOAT,	struct yc_table_t,	line[15].ic.raw)
	PT_ITEM("iz16",		PT_TYPE_FLOAT,	struct yc_table_t,	line[15].i0.raw)
	PT_ITEM("p16",		PT_TYPE_FLOAT,	struct yc_table_t,	line[15].p.raw)
	PT_ITEM("q16",		PT_TYPE_FLOAT,	struct yc_table_t,	line[15].q.raw)
	PT_ITEM("s16",		PT_TYPE_FLOAT,	struct yc_table_t,	line[15].s.raw)
	PT_ITEM("cos16",	PT_TYPE_FLOAT,	struct yc_table_t,	line[15].cos.raw)
