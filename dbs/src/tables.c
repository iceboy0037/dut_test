...
SDB_MAP_START(param_item_desc)
	SDB_MAP_ITEM(PT_TYPE_INT, 	struct param_item_t, devid)
	SDB_MAP_ITEM(PT_TYPE_INT, 	struct param_item_t, ptid)
	SDB_MAP_ITEM(PT_TYPE_INT, 	struct param_item_t, fun)
	SDB_MAP_ITEM(PT_TYPE_INT, 	struct param_item_t, inf)
	SDB_MAP_ITEM(PT_TYPE_STRING,	struct param_item_t, alias)
	SDB_MAP_ITEM(PT_TYPE_STRING, 	struct param_item_t, value)
	SDB_MAP_ITEM(PT_TYPE_STRING,	struct param_item_t, alias)
	SDB_MAP_ITEM(PT_TYPE_STRING, 	struct param_item_t, value)
	SDB_MAP_ITEM(PT_TYPE_STRING, 	struct param_item_t, def_val)
	SDB_MAP_ITEM(PT_TYPE_STRING, 	struct param_item_t, min_val)
	SDB_MAP_ITEM(PT_TYPE_STRING, 	struct param_item_t, max_val)
	SDB_MAP_ITEM(PT_TYPE_STRING, 	struct param_item_t, step)
	SDB_MAP_ITEM(PT_TYPE_STRING, 	struct param_item_t, unit)
	SDB_MAP_ITEM(PT_TYPE_INT, 	struct param_item_t, dtype)
	SDB_MAP_ITEM(PT_TYPE_STRING, 	struct param_item_t, tm)
SDB_MAP_END(param_item_desc)